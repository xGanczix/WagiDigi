      ...
      var e = {
          ...
          259: function (t, e, n) {
            ...
            e.parseCss = function (t, e, n, i, l) {
              ...
              -1 !== g.indexOf(i.textAlign) && (a.halign = i.textAlign),
                -1 !==
                  (g = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) &&
              ...
              for (var g = 0; g < s.rows.length; g++) {
                var p = s.rows[g],
                  y =
                    null ===
                      (a =
                        null === (l = null == p ? void 0 : p.parentElement) ||
                        void 0 === l
                          ? void 0
                          : l.tagName) || void 0 === a
                      ? void 0
                ...
                return (
                  ...
                  (t.prototype.callCellHooks = function (t, e, n, o, i, l) {
                    for (var a = 0, s = e; a < s.length; a++) {
                      var u =
                        !1 ===
                        (0, s[a])(new r.CellHookData(t, this, n, o, i, l));
                      if (
                        ((n.text = Array.isArray(n.text) ? n.text : [n.text]),
                        u)
                      )
                        return !1;
                    }
              ...
              return (
                ...
                (t.prototype.getMinimumRowHeight = function (t, e) {
                  ...
                  return t.reduce(function (t, r) {
                    ...
                    if (!i) return 0;
                    var l =
                        (i.styles.fontSize / e.scaleFactor()) *
                        o.FONT_ROW_RATIO,
          ...
          858: function (t, e, n) {
            ...
            e.createTable = function (t, e) {
              var n = new o.DocHandler(t),
                ...
                a = new r.Table(e, l);
              return (
                (0, i.calculateWidths)(n, a), n.applyStyles(n.userStyles), a
              );
            };
          },
          49: function (t, e, n) {
                ...
                var f = (function (t, e, n, o) {
                  ...
                  for (var l = 0, s = 0, u = n.columns; s < u.length; s++) {
                    ...
                    if ((m = t.cells[h.index])) {
                      ...
                      var g = o.scaleFactor();
                      (m.contentHeight = m.getContentHeight(g)),
                        m.contentHeight >= e &&
                          ((m.contentHeight = e),
                          (c.styles.minCellHeight -= e)),
                        m.contentHeight > t.height &&
                          (t.height = m.contentHeight),
                        (c.contentHeight = c.getContentHeight(g)),
                  ...
                  for (var y = 0, v = n.columns; y < v.length; y++) {
                    var m;
                    (h = v[y]),
                      (c = p.cells[h.index]) && (c.height = p.height),
                  ...
                  for (var a = 0, s = e.columns; a < s.length; a++) {
                    ...
                    if (d) {
                      ...
                      if (
                        ...
                        var g = 10 / n;
                        (d.minWidth = d.styles.minCellWidth || g),
                          (d.wrappedWidth = d.contentWidth),
                  ...
                  for (
                    ...
                    for (
                      ...
                      if (d) {
                        ...
                        d.rowSpan > 1 && n.count * n.height < f * d.rowSpan
                          ? (n = { height: f, count: d.rowSpan })
                          : n && n.count > 0 && n.height > f && (f = n.height),
                          f > i.height && (i.height = f);
                      }
                    }
                    n.count--;
                  }
